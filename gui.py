...
class DatabaseGUI:
    def __init__(self, root):
        ...
        self.node_configs = {
            ...
            # For multi-laptop: update with colleague IPs (e.g., "Slave 1": "192.168.149.138:8001", "Slave 2": "192.168.149.139:8002")
        }
        ...
        operations = ["CREATE_DB", "CREATE_TABLE", "INSERT", "UPDATE", "DELETE", "SEARCH", "DROP_DB"]
        ...
        # Initially show fields for CREATE_DB
        self.update_fields()
